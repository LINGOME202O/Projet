...
<br>
        <h1 style="text-align:center;font-size:45px;">Bienvenue dans le système de gestion des banques de sang et des donneurs</h1>
<br>
        <div class="row">
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >Le besoin de sang</h4>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white">Astuces sur le sang</h4>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header card bg-info text-white" >Qui pourriez-vous aider</h4>
        ...
        <h2>Noms des donneurs de sang</h2>
            ...
            <div class="card" style="width:300px">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">
                    ...
                    <b>Numéro : </b> <?php echo $row['donor_number']; ?><br>
...
<br>
        ...
        <div class="row mb-4">
            <div class="col-md-8">
            <h4>Donneurs et receveurs universels</h4>
            <p>
              <?php
                include 'conn.php';
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="align:center; background-color:#7FB3D5;color:#273746 ">Devenir un donneur </a>
            </div>
        </div>
