...
<body>
  ...
  <div class="row">
      <div class="col-lg-6">
          <h1 class="mt-4 mb-3">Besoin du sang</h1>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">Raison, pourquoi le besoin de sang?<span style="color:red">*</span></div>
<div><textarea class="form-control" name="address" required></textarea></div></div>
</div>
<div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="search" class="btn btn-primary" value="Rechercher" style="cursor:pointer"></div>
</div>
...
<?php if(isset($_POST['search'])){
  ...
  <?php
    ...
    else
    {
        ...
        echo '<div class="alert alert-danger">Pas de donneur trouvé  pour votre  groupe sanguin </div>';
